                        ...
                        <div  class="orderPageOrderItem">
                            <table width="800px" align="center" class="orderPageOrderItemTable">
                                <%--<c:forEach items="${o.orderItems}" var="oi">--%>
                                    <c:forEach items="${o.orderltem.product}" var="p">
                                        <%--<c:forEach items="${o.orderItems}" var="oi">--%>
                                        <tr>
                                            <td align="left">
                                                <img width="40px" height="40px" src="img/productSingle/${p.productimag.id}.jpg">
                                            </td>
                                            ...
                                            <td align="right">
                                                ...
                                                <%--<span class="text-muted">${}个</span>--%>
                                            </td>
                                            <td align="right">

                                                <span class="text-muted">单价：￥${p.promotePrice}</span>
                                            </td>
